...
traits = {
    ...
    OffenseTrait.RELIGION: {
        "name": _("Spiritual"),
        "description": _("With a deep spiritual connection, seeking harmony in all."),
    ...
    OffenseTrait.DISABILITY: {
        "name": _("Resilient"),
        "description": _("Showing unmatched resilience, overcoming every obstacle."),
        "image_url": settings.STATIC_URL + "images/jokometians/image_disability.svg",
    },
